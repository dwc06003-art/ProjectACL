...
st.subheader('Mutated DataFrame (col1: 1.0 ~ 2.0 사이 값만 출력)')
st.dataframe(df)


# 'Column 1'을 기반으로 새 컬럼 'Column 4' 생성
# 람다함수 : 이름없이 한 줄로 쓰는 간단한 함수
# 형식 : lambda 매개변수: 반환값
# 일반함수 - def add(x, y):
#               return x + y
# 람다식 - lambda x, y: x + y
